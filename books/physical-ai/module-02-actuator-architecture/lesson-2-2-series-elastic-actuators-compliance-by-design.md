...
```mermaid
flowchart LR
    E["Encoders on each side of spring"] --> DEF["Measure spring deflection"]
    DEF --> CALC["force = displacement x stiffness"]
    CALC --> LOOP["Close force-control loop"]
    LOOP --> CMD["Commanded joint force"]
```
