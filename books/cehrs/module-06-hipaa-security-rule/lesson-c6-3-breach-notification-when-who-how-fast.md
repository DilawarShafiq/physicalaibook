...
```mermaid
flowchart TD
    A["Unauthorized disclosure of unsecured PHI"] --> B{"4-factor assessment shows low probability of compromise"}
    B -->|Yes| C["No notification required"]
    B -->|No| D["Notify individuals within 60 days"]
    D --> E{"How many individuals affected"}
    E -->|"500 or more"| F["Notify HHS within 60 days and notify media within 60 days"]
    E -->|"Fewer than 500"| G["Log and report to HHS by March 1 annually"]
```
