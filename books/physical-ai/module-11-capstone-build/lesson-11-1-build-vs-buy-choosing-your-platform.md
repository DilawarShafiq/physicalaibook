...
sidebar_label: "11.1 Build vs Buy: Choosing Your Platform"
sidebar_position: 2
description: "The single biggest decision a robotics developer makes is whether to design custom hardware or buy a research platform"
tags: ["build-vs-buy", "platform", "unitree", "strategy"]
---

# Build vs Buy: Choosing Your Platform

**Duration:** 40 min · **Level:** Advanced · **Module:** 11. Capstone: From Platform to Working Robot · **Focus:** `build-vs-buy`, `platform`, `unitree`, `strategy`
...
Next: **11.2 Reference Build: Bringing Up a Unitree G1** →
