...
```mermaid
flowchart LR
    P["Cheap hardware at $16k"] --> R["Researchers adopt G1/H1"]
    R --> PAP["200+ papers in 12 months"]
    PAP --> IP["Data + algorithm IP for platform"]
    IP --> D["Becomes the field's default robot"]
    D --> R
```
